...
def collect_angle():
    ...
    while t2 >= 160 or t1 <= -160:
        t2 = int(input('pls input theta1: '))
    while t3 >= 160 or t1 <= -160:
        t3 = int(input('pls input theta1: '))
    while t4 >= 160 or t1 <= -160:
        t4 = int(input('pls input theta1: '))
    while t5 >= 160 or t1 <= -160:
        t5 = int(input('pls input theta1: '))
    while t6 >= 160 or t1 <= -160:
        t6 = int(input('pls input theta1: '))
